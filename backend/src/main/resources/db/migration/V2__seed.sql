...
-- ===========================
-- Users (uno por rol)
-- role: libre (string). priority: usar 'GENERAL' o 'RECTORADO' del enum.
-- Passwords demo en texto plano: cambiar por hash en prod.
-- ===========================
INSERT INTO users (active, created_at, updated_at, username, name, last_name, email, password, priority, role)
VALUES
  (b'1', @now, @now, 'admin.full',       'Admin',   'Full',       'admin.full@unla.edu.ar',       'admin123', 'RECTORADO', 'ADMIN_FULL'),
  (b'1', @now, @now, 'admin.ceremonial', 'Admin',   'Ceremonial', 'admin.ceremonial@unla.edu.ar', 'admin123', 'GENERAL',   'ADMIN_CEREMONIAL'),
  (b'1', @now, @now, 'admin.tecnica',    'Admin',   'Tecnica',    'admin.tecnica@unla.edu.ar',    'admin123', 'GENERAL',   'ADMIN_TECNICA'),
  (b'1', @now, @now, 'viewer',           'User',    'Usuario',     'viewer@unla.edu.ar',           'viewer123','GENERAL',   'USUARIO');
